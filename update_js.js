...
if (fs.existsSync(cssFile)) {
    ...
    // Replace CHENARI -> MyMart in CSS comments
    cssContent = cssContent.replace(/CHENARI/g, 'MyMart');
...
jsFiles.forEach(f => {
    if (fs.existsSync(f)) {
        ...
        // Replace CHENARI logo in main.js
        ...
        jsContent = jsContent.replace(/CHENARI/g, 'MyMart');
